...
class Configurable:
    ...
    @property
    def schema(self):
        return self._config.get('Data','schema')
    ...
    @property
    def train_file_list(self):
        return eval(self._config.get('Data','train_file_list'))

    @property
    def dev_file_list(self):
        return eval(self._config.get('Data','dev_file_list'))

    @property
    def test_file_list(self):
        return eval(self._config.get('Data','test_file_list'))
    ...
    @property
    def load_model_path_list(self):
        return eval(self._config.get('Save', 'load_model_path_list'))

    @property
    def train_domain_list(self):
        return eval(self._config.get('Save', 'train_domain_list'))
    ...
    @property
    def add_share_loss(self):
        return self._config.getboolean('Network','add_share_loss')

    @property
    def add_trans_loss(self):
        return self._config.getboolean('Network','add_trans_loss')
